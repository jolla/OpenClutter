...
- Hack on **https://openclutter.netlify.app/dev**. The title row shows a **dev** badge and the build version (`dev · v1.1.19`). The same dev host shows **Terrain resolution** (Auto / Default / Fine / 25 / 20 / 15 / 10 / 5 / 1 m) next to Include foliage. Auto is selected by default.
