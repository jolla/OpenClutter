...
- Hack on **https://openclutter.netlify.app/dev**. The panel corner shows a small muted build label (`dev · v1.1.22`). The same dev host shows **Terrain resolution** (Auto / Default / Fine / 25 / 20 / 15 / 10 / 5 / 1 m) next to Include foliage. Auto is selected by default.
