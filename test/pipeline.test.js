...
describe("main UI: import buildings, optional foliage", () => {
  ...
  it("index and app keep one Include foliage toggle, off unless checked", () => {
    ...
    assert.match(html, /Auto · from draw/);
    ...
    assert.match(app, /id: "finest", label: "Finest", cellM: 25, maxGrid: 20, readout: "Finest · ~25 m"/);
    assert.match(app, /id: "20", label: "20 m", cellM: 20, maxGrid: 125/);
    assert.match(app, /id: "15", label: "15 m", cellM: 15, maxGrid: 167/);
    assert.match(app, /id: "10", label: "10 m", cellM: 10, maxGrid: 250/);
    assert.match(app, /id: "5", label: "5 m", cellM: 5, maxGrid: 500/);
    assert.match(app, /id: "1", label: "1 m", cellM: 1, maxGrid: 500/);
